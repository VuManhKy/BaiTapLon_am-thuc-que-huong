...
function showDishDetail(dishId) {
    ...
    // 1. Tạo một biến để chứa HTML của bảng. Mặc định là chuỗi rỗng.
    let nutritionTableHtml = '';

    // 2. Kiểm tra xem đối tượng 'dish' có thuộc tính 'nutrition' hay không.
    if (dish.nutrition) {
        // Nếu có, thì tạo HTML cho cái bảng và gán vào biến đã tạo.
        nutritionTableHtml = `
            <h4 style="margin-top: 20px;">Thông Tin Dinh Dưỡng (Tham Khảo)</h4>
            <table class="nutrition-table">
                <thead>
                    <tr>
                        <th>Năng lượng (Calories)</th>
                        <th>Chất đạm (Protein)</th>
                        <th>Chất béo (Fat)</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td>${dish.nutrition.protein}</td>
                        <td>${dish.nutrition.fat}</td>
                    </tr>
                </tbody>
            </table>
        `;
    ...
    // 3. Chèn biến chứa bảng vào trong chuỗi HTML chính của modal.
    dishDetailContent.innerHTML = `
        ...
        <div class="dish-info">
            ...
            <!-- Biến nutritionTableHtml sẽ được chèn vào đây -->
            ${nutritionTableHtml}
